    ...
    class tsc_state
    {
        private:
            ...
            **/
            ...
            std::vector<int> convert_veh_phases_to_signal_groups(const std::vector<int> &veh_phases );

            std::vector<int> convert_ped_phases_to_signal_groups(const std::vector<int> &ped_phases );
        ...
        public:
            ...
            */
            ...
            int get_pedestrian_signal_group_id(const int phase_number);
