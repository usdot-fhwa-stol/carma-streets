...
TEST(test_message_lanelet2_translation, get_lanelet_types_ids_by_route)
{
    ...
    //From lanelet id = 19252 to 22414 to lanelet id = 12459
    std::int64_t start_lanelet_id = 19252;
    std::int64_t dest_lanelet_id = 12459;
    ASSERT_EQ(3, clt.get_lanelet_types_ids_by_route(start_lanelet_id, dest_lanelet_id).size());

    //From lanelet id = 22414 to lanelet id = 12459
    ...
    //From lanelet id = 12459 to lanelet id = 12459
