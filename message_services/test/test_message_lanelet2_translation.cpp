...
TEST(test_message_lanelet2_translation, get_cur_lanelet_id_by_loc_and_direction)
{
    ...
    ASSERT_EQ(22414, clt.get_cur_lanelet_id_by_loc_and_direction(38.9549432, -77.1493113, 72, "right"));
    ASSERT_EQ(22878, clt.get_cur_lanelet_id_by_loc_and_direction(38.9549432, -77.1493113, 72, "straight"));
    ASSERT_EQ(22528, clt.get_cur_lanelet_id_by_loc_and_direction(38.9549432, -77.1493113, 72, "left"));

    //Position within the link lanelet without turn direction
    ASSERT_EQ(0, clt.get_cur_lanelet_id_by_loc_and_direction(38.9549432, -77.1493113, 72, "NA"));
    ASSERT_EQ(0, clt.get_cur_lanelet_id_by_loc_and_direction(38.9549432, -77.1493113, 72, "NA"));
    ASSERT_EQ(0, clt.get_cur_lanelet_id_by_loc_and_direction(38.9549432, -77.1493113, 72, "NA"));

    //Position within the entry lanelet
    ASSERT_EQ(19252, clt.get_cur_lanelet_id_by_loc_and_direction(38.9548115, -77.1494016, 72, "NA"));
    ASSERT_EQ(19252, clt.get_cur_lanelet_id_by_loc_and_direction(38.9548053, -77.1494077, 72, "NA"));
    ASSERT_EQ(19252, clt.get_cur_lanelet_id_by_loc_and_direction(38.9547239, -77.1494634, 72, "NA"));

    //Position within the departure lanelet
    ASSERT_EQ(12459, clt.get_cur_lanelet_id_by_loc_and_direction(38.9549304, -77.1491166, 72, "NA"));
    ASSERT_EQ(12459, clt.get_cur_lanelet_id_by_loc_and_direction(38.9549256, -77.1490945, 72, "NA"));
}
...
TEST(test_message_lanelet2_translation, get_cur_lanelet_id_by_point_and_direction)
{
    ...
    ASSERT_EQ(19252, clt.get_cur_lanelet_id_by_point_and_direction(basic_point3d, ""));
    ...
    ASSERT_EQ(22414, clt.get_cur_lanelet_id_by_point_and_direction(basic_point3d, "right"));
    ASSERT_EQ(0, clt.get_cur_lanelet_id_by_point_and_direction(basic_point3d, ""));

    //Position within the departure lanelet return 1 lanelet
    point3d = {lanelet::utils::getId(), {-66.3387, 327.636, 72}};
    basic_point3d = point3d.basicPoint();
    ASSERT_EQ(12459, clt.get_cur_lanelet_id_by_point_and_direction(basic_point3d, ""));
}
...
TEST(test_message_lanelet2_translation, distance2_cur_lanelet_end_point)
{
    ...
    ASSERT_NEAR(15.033, clt.distance2_cur_lanelet_end(point3d, "right"), 0.01);

    //Position within the entry lanelet
    point3d = {lanelet::utils::getId(), {-96.40002062426407,304.71216057912693, 72}};
    ASSERT_NEAR(17.4779, clt.distance2_cur_lanelet_end(point3d, ""), 0.01);

    point3d = {lanelet::utils::getId(), {-91.5717516026476, 313.7486930462219, 72}};
    ASSERT_NEAR(7.12777, clt.distance2_cur_lanelet_end(point3d, ""), 0.01);

    point3d = {lanelet::utils::getId(), {-91.04298660840287,314.4369775722761, 72}};
    ASSERT_NEAR(6.08981, clt.distance2_cur_lanelet_end(point3d, ""), 0.01);

    //Position within the departure lanelet
    point3d = {lanelet::utils::getId(), {-66.33865452644577,327.63636981163864, 72}};
    ASSERT_NEAR(137.707, clt.distance2_cur_lanelet_end(point3d, ""), 0.01);

    point3d = {lanelet::utils::getId(), {-64.42300140950572,327.1034837742677, 72}};
    ASSERT_NEAR(135.699, clt.distance2_cur_lanelet_end(point3d, ""), 0.01);
}
