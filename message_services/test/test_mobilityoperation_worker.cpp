...
TEST(test_mobilityoperation_worker, pop_cur_element_from_list)
{
    ...
    std::string mobilityoperation_json_str_2 = "{\"header\": {\"timestamp\" : 1632679658,\"sender_id\": \"DOT-508\",\"sender_bsm_id\": \"bsmXXXid2\"}, \"strategy\": \"NA\",\"strategy_params\": \"hello:world,id:1\"}";
    ...
    ASSERT_EQ("world", mobilityoperation_w_obj.get_curr_list().front().get_value_from_strategy_params("hello"));
}