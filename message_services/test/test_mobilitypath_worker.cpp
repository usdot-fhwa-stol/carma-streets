...
TEST(test_mobilitypath_worker, process_incoming_msg)
{
    message_services::workers::mobilitypath_worker mobilitypath_w_obj;
    ASSERT_EQ(0, mobilitypath_w_obj.get_curr_list().size());
    std::string mobilitypath_json_str = "{\"header\": {\"timestamp\" : \"1632679657\",\"hostStaticId\": \"DOT-507\",\"hostBSMId\": \"bsmXXXid\"}, \"trajectory\": { \"location\": {\"ecef_x\": 122, \"ecef_y\": 1,\"ecef_z\": 0}}}";
...
TEST(test_mobilitypath_worker, pop_cur_element_from_list)
{
    message_services::workers::mobilitypath_worker mobilitypath_w_obj;
    ASSERT_EQ(0, mobilitypath_w_obj.get_curr_list().size());
    std::string mobilitypath_json_str_1 = "{\"header\": {\"timestamp\" : \"1632679657\",\"hostStaticId\": \"DOT-507\",\"hostBSMId\": \"bsmXXXid\"}, \"trajectory\": { \"location\": {\"ecef_x\": 122, \"ecef_y\": 1,\"ecef_z\": 0,\"timestamp\": \"1632679657\"}}}";
    std::string mobilitypath_json_str_2 = "{\"header\": {\"timestamp\" : \"1632679658\",\"hostStaticId\": \"DOT-508\",\"hostBSMId\": \"bsmXXXid\"}, \"trajectory\": { \"location\": {\"ecef_x\": 122, \"ecef_y\": 1,\"ecef_z\": 0,\"timestamp\": \"1632679657\"}}}";
    std::string mobilitypath_json_str_3 = "{\"header\": {\"timestamp\" : \"1632679659\",\"hostStaticId\": \"DOT-509\",\"hostBSMId\": \"bsmXXXid\", \"targetStaticId\": \"NA\"}, \"trajectory\": { \"location\": {\"ecef_x\": 122, \"ecef_y\": 1,\"ecef_z\": 0,\"timestamp\": \"1632679657\"}, \"offsets\": {\"offset_x\": 122, \"offset_y\": 1,\"offset_z\": 0}}}";
