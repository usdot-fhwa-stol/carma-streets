...
TEST(test_mobilitypath_worker, pop_cur_element_from_list)
{
    ...
    std::string mobilitypath_json_str_2 = "{\"metadata\": {\"timestamp\" : \"1632689758\",\"hostStaticId\": \"DOT-508\",\"planId\" : \"00000000-0000-0000-0000-000000000000\",\"hostBSMId\": \"bsmXXXid\"}, \"trajectory\": { \"location\": {\"ecefX\": 122, \"ecefY\": 1,\"ecefZ\": 0,\"timestamp\": \"1632679657\"}, \"offsets\": [{\"offsetX\": 122, \"offsetY\": 1,\"offsetZ\": 0}] }}";
    std::string mobilitypath_json_str_3 = "{\"metadata\": {\"timestamp\" : \"1632699859\",\"hostStaticId\": \"DOT-509\" ,\"planId\" : \"00000000-0000-0000-0000-000000000000\",\"hostBSMId\": \"bsmXXXid\"}, \"trajectory\": { \"location\": {\"ecefX\": 122, \"ecefY\": 1,\"ecefZ\": 0,\"timestamp\": \"1632679657\"}, \"offsets\": [{\"offsetX\": 122, \"offsetY\": 1,\"offsetZ\": 0}]}}";
    ...
    mobilitypath_w_obj.get_curr_map().erase("DOT-5071632679");
    ...
    ASSERT_EQ(1632689758, mobilitypath_w_obj.get_curr_map().begin()->second.getHeader().timestamp);
