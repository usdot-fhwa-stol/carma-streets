...
TEST(test_bsm_worker, pop_cur_element_from_list)
{
    message_services::workers::bsm_worker bsm_w_obj;
    ASSERT_EQ(0, bsm_w_obj.get_curr_list().size());
    std::string bsm_json_str_1 = "{\"header\": {\"timestamp\" : 1632679657},\"core_data\": {\"temprary_id\": \"bsmid1\", \"latitude\":38.956287,\"longitude\" :-77.150492,\"sec_mark\": 1632369320,\"speed\": 15,\"size\": { \"length\": 8}}}";
    std::string bsm_json_str_2 = "{\"header\": {\"timestamp\" : 1632679658},\"core_data\": {\"temprary_id\": \"bsmid2\", \"latitude\":38.956287,\"longitude\" :-77.150492,\"sec_mark\": 1632369321,\"speed\": 14,\"size\": { \"length\": 3}}}";
    std::string bsm_json_str_3 = "{\"header\": {\"timestamp\" : 1632679659},\"core_data\": {\"temprary_id\": \"bsmid3\", \"latitude\":38.956287,\"longitude\" :-77.150492,\"sec_mark\": 1632369322, \"speed\": 13 ,\"size\": { \"length\": 12}}}";
