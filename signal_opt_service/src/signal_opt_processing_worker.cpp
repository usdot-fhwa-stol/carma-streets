...
namespace signal_opt_service
{
        ...
        uint64_t final_green_buffer)
    {
        ...
        _selected_final_dpp = arbitrator.select_optimal_dpp(dpp_list, intersection_info_ptr, spat_ptr, tsc_config_state, veh_list_ptr, initial_green_buffer, final_green_buffer);
    }
}