...
namespace sensor_data_sharing_service {
    ...
    streets_utils::messages::sdsm::sensor_data_sharing_msg sds_service::create_sdsm() {
        ...
        for (const auto &[object_id, object] : detected_objects){
            ...
            auto transformed_object_data = detected_object_local_to_ref(ned_object, ref_proj_string);
            auto detected_object_data = to_detected_object_data(transformed_object_data, timestamp);
